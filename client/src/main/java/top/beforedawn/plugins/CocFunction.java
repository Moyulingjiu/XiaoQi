        ...
        switch (message) {
            ...
            */
            ...
            case "coc超弓":
                ...
                break;
            case "coc超级巨人":
                sendCocImage(singleEvent, "兵种介绍-超级巨人.jpg");
                break;
            case "coc超级法师":
            case "coc超法":
                sendCocImage(singleEvent, "兵种介绍-超级法师.jpg");
                break;
            case "coc隐秘哥布林":
            case "coc超级哥布林":
            case "coc超哥":
                sendCocImage(singleEvent, "兵种介绍-隐秘哥布林.jpg");
                break;
            case "coc超级炸弹人":
            case "coc超炸":
                sendCocImage(singleEvent, "兵种介绍-超级炸弹人.jpg");
                break;
            case "coc超级气球":
            ...
            case "coc超级武神":
                ...
                break;
            case "coc超级女巫":
                sendCocImage(singleEvent, "兵种介绍-超级女巫.jpg");
                break;
            case "coc寒冰猎犬":
            case "coc冰狗":
                sendCocImage(singleEvent, "兵种介绍-寒冰猎犬.jpg");
                break;
            case "coc超级巨石投手":
            case "coc超级蓝胖":
            case "coc超蓝":
                sendCocImage(singleEvent, "兵种介绍-超级蓝胖.jpg");
                break;
            /*
                英雄
             */
